...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWebView();
        mWebView.loadUrl("http://dwww.topzrt.com/wap/summit?active=activity&from=app&tid=MM_app&version_name=3.5.4&sid=0&is_pc=101&singnature=c920d2be441f88bd813ad0f4f10f5203");
