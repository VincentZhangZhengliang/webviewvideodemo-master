...
public class TagUtils {
    ...
    public static String getJs(String url) {
        ...
        Log.e("Vincent", "getJs: " + tag);
        if (TextUtils.isEmpty(tag)) {
            return "javascript:";
        } else {
//            return "javascript:document.getElementsByClassName('" + "zy_fullscreen_btn" + "')[0].addEventListener('click',function(){onClick.fullscreen();return false;});";
